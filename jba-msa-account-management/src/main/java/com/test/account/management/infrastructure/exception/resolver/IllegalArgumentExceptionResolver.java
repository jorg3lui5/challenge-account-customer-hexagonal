...
import com.test.account.management.infrastructure.input.adapter.rest.bs.bean.ErrorList;
...
import static com.test.account.management.util.Constants.BAD_INPUT;
