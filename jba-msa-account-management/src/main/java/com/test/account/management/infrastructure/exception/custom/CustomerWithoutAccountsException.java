...
public class CustomerWithoutAccountsException extends FailureException {
    public CustomerWithoutAccountsException() {
        super(new ErrorModel()
                    .type(CONFLICT)
                    .title("Sin registros")
                    .detail("El cliente no tiene cuentas registradas")
