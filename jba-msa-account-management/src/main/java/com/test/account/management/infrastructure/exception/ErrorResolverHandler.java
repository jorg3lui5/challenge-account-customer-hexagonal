package com.test.account.management.infrastructure.exception;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.test.account.management.infrastructure.exception.custom.*;
import com.test.account.management.infrastructure.exception.resolver.*;
...
public class ErrorResolverHandler implements ErrorWebExceptionHandler {
    ...
    private void initializeResolvers() {
        ...
        resolvers.put(AccountByCustomerIdNotFoundException.class, new FailureExceptionResolver());
        resolvers.put(AccountByIdNotFoundException.class, new FailureExceptionResolver());
        resolvers.put(AccountMovementNotFoundException.class, new FailureExceptionResolver());
        resolvers.put(AccountNotUpdateByExistingMovementsException.class, new FailureExceptionResolver());
        resolvers.put(CustomerAccountNotFoundException.class, new FailureExceptionResolver());
        resolvers.put(CustomerNotFoundException.class, new FailureExceptionResolver());
        resolvers.put(DeleteException.class, new FailureExceptionResolver());
        resolvers.put(GetCustomerException.class, new FailureExceptionResolver());
        resolvers.put(GetRegisterException.class, new FailureExceptionResolver());
        resolvers.put(GetRegistersException.class, new FailureExceptionResolver());
        resolvers.put(InvalidDateMovement.class, new FailureExceptionResolver());
        resolvers.put(InvalidDebitAmountException.class, new FailureExceptionResolver());
        resolvers.put(MethodNotImplementException.class, new FailureExceptionResolver());
        resolvers.put(MovementByIdNotFoundException.class, new FailureExceptionResolver());
        ...
        resolvers.put(UpdateException.class, new FailureExceptionResolver());
